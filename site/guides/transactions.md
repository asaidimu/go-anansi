---
title: Transactions
description: "Atomic units of work — facade p.Transact vs coll.Transact, nesting, concurrent ops, hooks, events, error sentinels."
---
...
against the source (`core/persistence/transaction/transaction.go`,
