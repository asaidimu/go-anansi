---
title: Caching
description: "The caching layers (core/cache, ModelCollection id-cache, LiveCollection), the document Release()/pooling contract, why ModelCollection is the fast path."
---
