---
title: Struct Tag Spec
description: "How idiomatic Go structs map to the meta-schema JSON definition — the anansi struct tag grammar, type inference, default field promotion, UUIDv7 ordering."
---
...
```go
user := document.New(&User{Username: "alice", Email: "alice@example.com"})
