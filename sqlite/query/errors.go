...
var (
        ...
        ErrCollectionViewNameNotDefined      = common.NewSystemError("ERR_QUERY_VIEW_NAME_NOT_DEFINED", "view name is not defined")
        ErrCollectionViewSelectNotDefined    = common.NewSystemError("ERR_QUERY_VIEW_SELECT_NOT_DEFINED", "view select query is not defined")
        ErrCollectionViewFactoryNotDefined   = common.NewSystemError("ERR_QUERY_VIEW_FACTORY_NOT_DEFINED", "view factory is not defined")
)
