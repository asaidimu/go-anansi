...
func (i *sqliteFactory) Capabilities() query.Capabilities {
        return query.Capabilities{
                ...
                SupportedTextSearchTypes: map[query.TextSearchType]struct{}{
                        // SQLite FTS5 virtual tables back all three TextSearchType
                        // variants. Each fulltext index declared on a schema produces
                        // an FTS5 virtual table whose MATCH operator handles
                        // tokenization, prefix matching, and phrase queries natively.
                        query.TextSearchTypeContains: {},
                        query.TextSearchTypeExact:    {},
                        query.TextSearchTypePhrase:   {},
                },
