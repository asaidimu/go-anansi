...
var (
        ...
        ErrCouldNotBuildCreateViewQuery   = common.NewSystemError("ERR_NATIVE_COULD_NOT_BUILD_CREATE_VIEW_QUERY", "could not build query for creating materialized view")
        ErrCouldNotCreateView             = common.NewSystemError("ERR_NATIVE_COULD_NOT_CREATE_VIEW", "could not create materialized view")
        ErrCouldNotBuildRefreshViewQuery  = common.NewSystemError("ERR_NATIVE_COULD_NOT_BUILD_REFRESH_VIEW_QUERY", "could not build query for refreshing materialized view")
        ErrCouldNotRefreshView            = common.NewSystemError("ERR_NATIVE_COULD_NOT_REFRESH_VIEW", "could not refresh materialized view")
)
