...
import (
	...
	sql "github.com/asaidimu/go-anansi/v8/sqlite/query"
...
func TestSimpleScalarSubquery(t *testing.T) {
	...
	expectedSQL := `SELECT "age" AS 'age', "id" AS 'id', "name" AS 'name' FROM "users" WHERE "age" > (SELECT AVG("age") FROM "users")`
...
func TestSubqueryWithIN(t *testing.T) {
	...
	expectedSQL := `SELECT "id" AS 'id', "total" AS 'total', "user_id" AS 'user_id' FROM "orders" WHERE "user_id" IN (SELECT "id" FROM "users" WHERE "department" = $1)`
	assert.Equal(t, expectedSQL, value.Raw().SQL)
...
func TestSubqueryWithJoin(t *testing.T) {
	...
	expectedSQL := `SELECT "id" AS 'id', "user_id" AS 'user_id' FROM "orders" WHERE "user_id" IN (SELECT "u"."id" FROM "users" AS "u" INNER JOIN "departments" AS "d" ON "u"."department_id" = "d"."id" WHERE "d"."name" = $1)`
	assert.Equal(t, expectedSQL, value.Raw().SQL)
	assert.Equal(t, []any{"Engineering"}, value.Raw().Params)
}
...
func TestNestedSubqueries(t *testing.T) {
	...
	expectedSQL := `SELECT "id" AS 'id', "user_id" AS 'user_id' FROM "orders" WHERE "user_id" IN (SELECT "id" FROM "users" WHERE "department_id" IN (SELECT "id" FROM "departments" WHERE "region" = $1))`
	assert.Equal(t, expectedSQL, value.Raw().SQL)
...
func TestCorrelatedSubquery(t *testing.T) {
	...
	expectedSQL := `SELECT "id" AS 'id', "name" AS 'name' FROM "users" AS "u" WHERE "dummy" > (SELECT COUNT(*) FROM "orders" AS "o" WHERE "o"."user_id" = "u"."id")`
